...
let big_int =
  [
    ...
    test {|.|} {|-99999999999999999999999999999|}
      {|-99999999999999999999999999999|};
    test {|9223372036854775808|} {|null|} {|9223372036854775808|};
    test {|99999999999999999999999999999|} {|null|}
      {|99999999999999999999999999999|};
    test {|-99999999999999999999999999999|} {|null|}
      {|-99999999999999999999999999999|};
    test {|.foo|} {|{"foo": 99999999999999999999999999999}|}
      {|99999999999999999999999999999|};
    test {|.[]|} {|[99999999999999999999999999999, 42]|}
      "99999999999999999999999999999\n42";
    test {|.[0]|} {|[99999999999999999999999999999]|}
      {|99999999999999999999999999999|};
    test {|to_string|} {|99999999999999999999999999999|}
      {|"99999999999999999999999999999"|};
    test {|type|} {|99999999999999999999999999999|} {|"number"|};
    test {|"\(.)"|} {|99999999999999999999999999999|}
      {|"99999999999999999999999999999"|};
    test {|99999999999999999999999999999 + 1|} {|null|}
      {|100000000000000000000000000000|};
    test {|99999999999999999999999999999 - 1|} {|null|}
      {|99999999999999999999999999998|};
    test {|99999999999999999999999999999 * 2|} {|null|}
      {|199999999999999999999999999998|};
    test {|. + 1|} {|99999999999999999999999999999|}
      {|100000000000000000000000000000|};
    test {|. * 2|} {|99999999999999999999999999999|}
      {|199999999999999999999999999998|};
    test {|. - 1|} {|99999999999999999999999999999|}
      {|99999999999999999999999999998|};
    test {|. % 10|} {|99999999999999999999999999999|} {|9|};
    test {|99999999999999999999999999999 == 99999999999999999999999999999|}
      {|null|} {|true|};
    test {|99999999999999999999999999999 < 100000000000000000000000000000|}
      {|null|} {|true|};
    test {|99999999999999999999999999999 > 99999999999999999999999999998|}
      {|null|} {|true|};
    test {|abs|} {|-99999999999999999999999999999|}
      {|99999999999999999999999999999|};
    test {|length|} {|-99999999999999999999999999999|}
      {|99999999999999999999999999999|};
  ]

...
let escape_then_plain_json = {|"abcAdef"|}
let escape_then_plain_value : Json.t = `String "abcAdef"
let unicode_null_json = {|"\u0000"|}
let unicode_null_value : Json.t = `String "\000"
let invalid_utf8_json = "\"\255\254 hi \192\128\""
let invalid_utf8_value : Json.t = `String "\255\254 hi \192\128"
let long_unescaped_string_json = "\"" ^ String.make 100_000 'x' ^ "\""
let long_unescaped_string_value : Json.t = `String (String.make 100_000 'x')

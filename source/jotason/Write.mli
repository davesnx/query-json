...
val seq_to_string :
  ?buf:Buffer.t -> ?len:int -> ?suf:string -> ?std:bool -> t Seq.t -> string
...
val seq_to_file :
  ?len:int -> ?suf:string -> ?std:bool -> string -> t Seq.t -> unit
...
module Pretty : sig
  val to_buffer_colored :
    Buffer.t -> colorize:bool -> summarize:bool -> t -> unit

...
let tests =
  [
    ...
    (* Deprecated camelCase path functions *)
    test "getpath" "null" "getpath is deprecated. Use get_path instead";
    test "setpath" "null" "setpath is deprecated. Use set_path instead";
    test "delpaths" "null" "delpaths is deprecated. Use delete_paths instead";
    (* snake_case path functions require arguments *)
    test "get_path" "null" "get_path() requires a path argument";
    test "set_path" "null" "set_path() requires arguments";
    test "delete_paths" "null" "delete_paths() requires arguments";
